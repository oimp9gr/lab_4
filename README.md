...
объекта класса <code>Number</code> и умножать первый на второй. В случае успешного умножения функция должна возвращать строку - результат полученный при умножении. 

Если при умножении было вызвано исключение функция должна вернуть строку с информацией об исключении:
